<template>
  <div class="flex items-center gap-x-1">
    ...
    <i class="fas fa-arrow-right text-accent-600 px-1 text-sm"></i>
    <div class="whitespace-nowrap overflow-hidden font-semibold tracking-tight">
...
<style module>
.golden {
  background: linear-gradient(180deg, #f6ddb4 0%, #e4be8a 55%, #cfa05f 100%);
  -webkit-background-clip: text;
  background-clip: text;
  -webkit-text-fill-color: transparent;
  filter: drop-shadow(0 0 5px rgba(228, 190, 138, 0.45));
  font-weight: 700;
}
</style>
