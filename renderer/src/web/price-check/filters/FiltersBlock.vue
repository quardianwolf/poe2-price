    ...
    >
      ...
      <div class="flex gap-x-4">
        <button
          ...
          class="px-2 py-1 text-gray-300 leading-none rounded-b w-40 border border-t-0 border-white/5 transition-colors hover:text-accent-100"
          style="background: linear-gradient(to bottom, #1b2230, #11161f)"
        >
          {{ t("filters.collapse") }}
          <i class="fas fa-chevron-up pl-1 text-xs text-accent-500"></i>
        </button>
        <ui-toggle
...
.presetBtn {
  ...
  &.active {
    ...
    border-bottom: 2px solid theme("colors.accent.500");
  }
}
</style>
